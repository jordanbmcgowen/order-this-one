          ...
          return (
                  <div className="min-h-screen flex flex-col items-center justify-center px-6 bg-background">
                          <div className="flex flex-col items-center gap-6 text-center">
                                    ...
                                    <div>
                                                <h1 className="text-xl font-bold text-foreground">Finding you...</h1>h1>
          ...
          return (
                  <div className="min-h-screen flex flex-col items-center justify-center px-6 bg-background">
                          <div className="flex flex-col items-center gap-6 text-center max-w-sm w-full">
                                    ...
                                    <div>
                                                <h1 className="text-xl font-bold text-foreground">Where are you dining?</h1>h1>
                                                <p className="text-sm text-muted-foreground mt-2">
                            ...
                            {locationError === "not_found" && (
                                <p className="text-xs text-destructive">Could not find that location. Try a different search.</p>p>
                                    )}
                          </div>div>
                  </div>div>
                );
                                      ...
                                      {recommendation.priceRange}
                                                ...
                                                <Card className="mt-6 p-4 border-primary/20 bg-primary/5">
                                                              <div className="flex items-start gap-3">
                                                                              ...
                                                                              <div>
                                                                                                <p className="text-sm font-semibold text-foreground">Why this dish?</p>p>
                ...
                <div className="max-w-lg mx-auto px-4 py-6">
                        <header className="mb-6">
                                  <div className="flex items-center gap-2">
                                              ...
                                              <h1 className="text-lg font-bold text-foreground">Order This One</h1>h1>
                                  </div>div>
                        ...
                        <button
                          ...
                          {locationLabel}
                                      <span className="text-muted-foreground ml-1">Change</span>span>
                        </button>button>
                                  )}
                        </header>header>
                          ...
                          {predictions.map((prediction) => (
                                          <button
                                                            ...
                                                            <div className="min-w-0">
                                                                                <p className="text-sm font-medium text-foreground truncate">{prediction.name}</p>p>
                                                                                <p className="text-xs text-muted-foreground truncate">{prediction.description}</p>p>
                                                            </div>div>
                                          </button>button>
                                        ))}
                        </div>div>
                  ...
                  {isSearchingRestaurant && (
                      <div className="flex items-center justify-center py-8 mb-4">
                                  ...
                                  <span className="text-sm text-muted-foreground">Loading restaurant details...</span>span>
                      </div>div>
                        )}
